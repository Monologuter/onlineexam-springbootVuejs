...
public class QiniuCloudUtil {
    ...
    // 设置需要操作的账号的AK和SK
    private static final String ACCESS_KEY = "lb5PC64hS-6tcINgYqIBDvzbIIHVlr0CZ7lM70bT";
    private static final String SECRET_KEY = "JlMQ4hFserulVHnXVK2kGq64ZChvERYxNTfBMQ0e";

    // 要上传的空间
    private static final String bucketname = "graduationblog";
    ...
    public static String put64image(byte[] data, String key){
        //图片的外链地址
        StringBuffer imgUrl  = new StringBuffer("http://image.educy.top/");
